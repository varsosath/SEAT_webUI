 ...
 ; (function ($) {
    ...
    $.fn.dynamicTable = function (options) {
        var settings = $.extend({}, {
            ...
            buttons: {
                addButton: ' <i style=" top:50%; cursor:pointer" class="fa fa-plus fa-lg"/i>Add<p>',
                cancelButton: ' <i style="cursor:pointer" class="fa fa-remove fa-lg"></i>',
                deleteButton: ' <i style="cursor:pointer" class="fa fa-trash fa-lg"></i>',
                editButton: ' <i  style="cursor:pointer" class="fa fa-edit fa-lg"></i>',
                saveButton: ' <i style="cursor:pointer" class="fa fa-save fa-lg"></i>'
            },
            columns: [],
            data: [],
